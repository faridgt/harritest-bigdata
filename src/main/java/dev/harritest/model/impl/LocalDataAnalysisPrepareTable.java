...
public class LocalDataAnalysisPrepareTable implements DataAnalysisPrepareTable{
	...
	for (String c:cnts) {
	  ...
	  maxds.write().option("header", true).mode(SaveMode.Overwrite).parquet(AppConf.LOCAL_DEST_PREPARE_ANALYSIS_PATH+"prepare_data_table.parquet");
